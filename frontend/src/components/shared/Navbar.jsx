...
const Navbar = () => {
  ...
  return (
    <div className="bg-white">
      <div className="flex items-center justify-between mx-auto px-2 max-w-7xl h-16">
        <div>
          <h1 onClick={(()=>navigate("/"))} className=" cursor-pointer text-2xl font-bold">
            Grab<span className="text-[#F83002]">Job</span>
          </h1>
        </div>
              ...
              <PopoverContent className="w-80">
                <div className="">
                  ...
                  <div className="flex flex-col text-grey-600 my-2">
                    ...
                    <div className="flex w-fit items-center gap-2 cursor-pointer">
                      <LogOut />
                      <Button onClick={logoutHandeler} variant="link">
                        Logout
                      </Button>
                    </div>
                  </div>
              ...
              <ul className="flex flex-col font-medium gap-4 p-4">
                ...
                {!user ? (
                  ...
                  <>
                    ...
                    <li className="flex items-center" onClick={logoutHandeler}>
                      <LogOut />
